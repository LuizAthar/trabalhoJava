...
public class Fogo extends Pokemon {
    ...
    private static String atk1 = "Flamethrower";
    private static String atk2 = "Fire Blast";
    private static String atk3 = "Ember";
    private static boolean defender;

    public Fogo(String codigo, String nome, int saude, Tipo tipo) {
    ...
    public void curar(Pokemon jogador) {
        setSaude((int) (getSaude() + (getSaude() * 0.6)));
    }

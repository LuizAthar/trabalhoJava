...
public class Veneno extends Pokemon {
    ...
    private static final String atk1 = "VenoShock";
    private static final String atk2 = "SludgeBomb";
    private static final String atk3 = "BodySlam";
    private static boolean defender = false;

    public Veneno(String codigo, String nome, int saude, Tipo tipo) {
